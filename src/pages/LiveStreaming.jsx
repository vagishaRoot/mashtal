...
const LiveStreaming = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center">
      <div className="flex flex-col items-center w-full max-1024:w-[95%]">
      ...
      <div className="w-full flex justify-center py-2">
        <div className="flex w-[85%] gap-x-8 py-[70px] border-b border-gray-200 relative max-1024:w-[95%] max-550:flex-wrap max-550:gap-y-[20px]">
          <div className="absolute z-0 bottom-[15px] -right-[70px] max-1024:-right-[20px]">
            <Icons string="video" />
          </div>
          <Link className="w-1/2 relative z-10 max-550:w-full" to="/video_live_streaming">
            <img src={mumbai} className="w-full min-h-[200px] object-cover rounded-[15px]" />
            <div className="absolute flex flex-col p-6 items-start gap-y-[5px] top-0">
              ...
              <div className="text-3xl text-white text-poppins max-768:text-xl">
                12 December 2024
              </div>
              <div className="text-[#B8B8B8] font-[600]">
                9:30 AM to 5:30 PM
              </div>
              <div className="py-[10px] px-[15px] bg-[#FFFFFFE5] text-[#FF0000] items-center rounded-sm flex gap-x-[10px] text-lg mt-[10px] tracking-wide text-poppins max-1024:mt-0">
                Live{" "}
          ...
          <Link className="w-1/2 relative z-10 max-550:w-full" to="/video_live_streaming">
            <img src={pune} className="w-full min-h-[200px] object-cover rounded-[15px]" />
            <div className="absolute flex flex-col p-6 items-start gap-y-[5px] top-0">
              <div className="text-4xl font-bold text-white max-768:text-2xl">Puna</div>
              <div className="text-3xl text-white text-poppins max-768:text-xl">
                12 December 2024
              </div>
              <div className="text-[#B8B8B8] font-[600]">
      ...
      <div className="w-full flex justify-center py-2">
        <div className="flex w-[85%] gap-y-8 flex-col py-[40px] max-1024:w-[95%]">
          ...
          <div className="bg-[#F8F8F8] w-full py-[20px] px-[30px] flex justify-between rounded-[10px] max-991:flex-wrap max-991:gap-y-[10px]">
            <div className="flex gap-x-[10px] items-center max-650:flex-wrap max-650:gap-y-[10px]">
              ...
              <div className="h-full w-[1px] bg-[#565972] max-650:hidden"></div>
              <div className="flex gap-x-[10px] items-center">
            ...
            <div className="flex items-center gap-x-[25px] max-991:justify-between max-991:w-full">
              <input
                type="text"
                placeholder="Enter City"
                className="w-[207px] h-full px-[5px] border border-[#565972] rounded-md max-425:w-[150px]"
              />
      ...
      <div className="w-[85%] flex flex-col gap-y-[36px] border-b border-[#ECECEC] py-[40px] relative max-1024:w-[95%]">
        ...
        <div className="grid grid-cols-3 gap-[30px] z-10 max-768:grid-cols-2 max-550:grid-cols-1">
      ...
      <div className="w-[85%] flex flex-col gap-y-[36px] py-[40px] relative max-1024:w-[95%]">
        <div className="absolute top-[31px] -left-[32px] z-0">
          <Icons string="photo-film-svg" />
        </div>
        <div className="flex gap-x-[10px] items-center z-10">
